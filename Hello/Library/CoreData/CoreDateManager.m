...
- (void)insertCoreData:(NSMutableArray*)dataArray
{
    ...
    for (UserFans *info in dataArray) {

        UserFans *fansInfo = [NSEntityDescription insertNewObjectForEntityForName:TableName inManagedObjectContext:context];
        
        fansInfo.iconurl = info.iconurl;
        fansInfo.name = info.name;
        fansInfo.descript = info.descript;
        fansInfo.source = info.source;
...
- (NSMutableArray*)readCoreData
{
    ...
    for (UserFans *fans in fetchedObjects) {
