...
// ServerAPI 的回调
@class KBaseServerAPI;
typedef void(^KServerAPICompletionBlock)(KBaseServerAPI *);

@interface KBaseServerAPI : NSObject
...
@property (nonatomic, copy) KServerAPICompletionBlock userBlock;  // serverapi回调的block
...
// state
@property (nonatomic, assign) KProcessStateEnum state;
...
- (void)accessAPI:(NSString *)api
    ...
    requestMethod:(KHttpRequestMethod)method
  completionBlock:(KServerAPICompletionBlock)block;
